 ...
 * generated in the view.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://view/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://view/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://view/", "uploadResponse");
    private final static QName _Upload_QNAME = new QName("http://view/", "upload");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: view.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://view/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://view/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://view/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://view/", name = "upload")
